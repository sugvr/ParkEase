...
import { signOut, useSession, signIn, getSession, SessionProvider } from "next-auth/react";
        ...
        <body className="relative bg-white overflow-hidden max-h-screen">
            ...
            <aside className="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
                <div className="flex flex-col justify-between h-full">
                    <div className="flex-grow">
                        ...
                        <div className="p-4">
                            <ul className="space-y-1">
                                <li>
                                    <Link href="" className="flex items-center bg-black rounded-xl font-bold text-sm text-amber-500 py-3 px-4">
                                ...
                                <li>
                                    <Link href="" className="flex bg-white hover:bg-yellow-50 rounded-xl font-bold text-sm text-gray-900 py-3 px-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-lg mr-4" viewBox="0 0 16 16">
                    ...
                    <div className="p-4">
                        <button onClick={() => session ? signOut() : signIn()} type="button" className="inline-flex items-center justify-center h-9 px-4 rounded-xl bg-gray-900 text-gray-300 hover:text-white text-sm font-semibold transition">
                        ...
                        </button> <span className="font-bold text-sm ml-2">{session ? 'Logout' : 'Login'}</span>
                    </div>
